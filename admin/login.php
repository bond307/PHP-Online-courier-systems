...
<head>
    ...
    <title>Admin Loing System :: Nogor-Curiar Service</title>
    <!-- Custom CSS -->
               ...
               <div class="col-md-6 offset-md-3 col-sm-12">
                <div class="registration-form">
                  ...
                  <div class="registra-logo col-md-4 offset-md-2 ">
                      <img src="image/logo2.png" class="light-logo bg-white " alt="">
                  </div>
                                ...
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text bg-main text-white" id="basic-addon1"><i class="fa fa-lock"></i></span>
                                            ...
                                            <input type="password" class="form-control pwd" placeholder="Password" name="admin_pass">
