        ...
        <div class="container-fluid">
            <div class="card m-t-20">
                <div class="card-header bg-info">
                    <h4 class="text-white p-t-10">Today Order's </h4>
                </div>
                <div class="card-body">
                        ...
                        <table id="zero_config" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <?php 
                                  $sr = 0;
                                      $date = date('M-d-y');
                                    $sql = "SELECT * FROM `customer_order` WHERE order_date = '$date' ";
                                    ...
                                    <td><a href="order-details.php?id=<?php echo $row['id'] ;?>" class="btn btn-outline-primary">View</a></td>
                                </tr>
