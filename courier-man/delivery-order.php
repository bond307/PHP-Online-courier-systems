                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="zero_config" class="table table-striped table-bordered">
                           ...
                           <?php 
                                  $sr = 0;
                                    if(mysqli_query($conn,"SELECT * FROM `delivery_order` WHERE boy_id = '".$_SESSION['id']."'")){
                                        
                                        $sql = "SELECT * FROM `customer_order` WHERE delivery_boy_id = '".$_SESSION['id']."' AND status = 'Processing' ";
                                ...
                                ?>                
                                    ...
                                    <td class="text-danger font-20"><?php echo $row['in_total'] ;?></td>
