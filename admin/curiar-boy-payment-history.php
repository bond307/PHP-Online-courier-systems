     ...
     <div class="payment-histry">
         <div class="card">
             <div class="card-header alert alert-warning">
                 <h5 class="text-white p-t-10 text-center font-18 text-dark"> Curiar Success Payment Histry</h5>
             </div>
                    ...
                    <div class="table-responsive">
                        <table id="zero_config" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                <?php 
                                $sr = 0;
                                $sql = "SELECT * FROM `curiar_boy_payment_histry` WHERE payment_status='Success' ";
                                    ...
                                    ?>
                                     ...
                                     <td><?php echo $row['payment_amount']; ?></td>
                                       ...
                                       <?php 
                                        ...
                                        <td><a href="curiar-payment-details.php?id=<?php echo $row['id'];?>" class="btn btn-outline-warning">view</a></td>
