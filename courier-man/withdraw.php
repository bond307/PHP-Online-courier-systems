...
if($amount <= $curnt_balance){
            ...
            $sql = "INSERT INTO `curiar_boy_payment_histry` (`id`, `customer_account_number`, `acount_name`, `payment_amount`, `Bkash`, `Bkash_number`, `Nogod`, `Nogod_number`, `roket`, `roket_number`, `Bank`, `Bname`, `BraName`, `Aname`, `Anumber`, `payment_date`, `payment_status`, `payment_user_id`, `apymne_accpect_date`) 
   ...
   $banalceError = ' <div class="alert alert-danger">
    আপনার কারেন্ট <b>'.$curnt_balance.'</b> বেলেন্স টাকা।
</div>';
}     
...
<div class="page-wrapper">
    ...
    <div class="card ">
        ...
        <div class="card-header">
            <h5 class="float-left">টাকা উত্তোলন করুনঃ </h5>
            <a class="btn btn-danger btn-rounded float-right" href="payment-histry.php">Payments Histry</a>
        </div>
