...
if(isset($_POST['submit'])) {
     ...
     //email check 
    $emailSQL = mysqli_query($conn, "SELECT email FROM customer_registration_tbl WHERE email = '".$_POST['email']."' ");
    
    if(mysqli_num_rows($emailSQL) > 0){
        $error = '<div class="alert alert-danger">
            <strong>This email is already is exist is our record.. Try another Email</strong>
        </div>';
    }else{
        $email = $_POST['email'];
...
if(move_uploaded_file($_FILES['profile']['tmp_name'], $target)) {
    ...
    if($result){
       header('Location: login.php?succcess=success');
                            ...
                            <div class="col-md-6 offset-md-3">
                                <div class="form-group">
                                    <div class="p-t-20 text-center">
                                        ...
                                        <p class="p-t-20">আপনার ইতমধ্যে একটি একাউন্ট আছে? </p>
